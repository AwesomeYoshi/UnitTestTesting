    ...
    public class UnitTest1
    {
        ...
        public void Matrix3Multiply()
        {
            ...
            Assert.IsTrue(compare(m3d,
                new Matrix3(-0.981004655361f, 0.193984255195f, 0,0.129707172513f, 0.655946731567f, 0.743579149246f, 0.14424264431f, 0.729454636574f, -0.668647944927f)));
        }
        ...
        public void Matrix4Multiply()
        {
            ...
            Assert.IsTrue(compare(m4d,
                new Matrix4(-0.644213855267f, -0.659384667873f, -0.387556940317f, 0, -0.565019249916f, 0.751805722713f, -0.339913755655f, 0, 0.515501439571f, 0, -0.856888711452f, 0, 0, 0, 0, 1)));
        }
        ...
        public void Vector4MatrixTranslation2()
        {
            ...
            m4c.m4 = 55; m4c.m8 = 44; m4c.m12 = 99; m4c.m16 = 1;
            Vector4 v4a = new Vector4(13.5f, -48.23f, -54, 1);
